    ...
    for policy in policies:
      ...
      for metric in metrics:
        ...
        for axis in [0,1]:
          ...
          np.save(DATA_FOLDER + "matrix_" + "itc_netdem_efc_vs_wp_heatmap_{p}policy_{y}year_{m}metric_{a}".format(m=metric,p=policy,y=year,a=area),itc_efc_vals)
          ...
          plt.savefig(FIGURE_FOLDER + "itc_netdem_efc_vs_wp_heatmap_{p}policy_{y}year_{m}metric_{a}.png".format(m=metric,p=policy,y=year,a=area),bbox_inches='tight')
          plt.close()
